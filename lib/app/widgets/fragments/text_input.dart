...
///
/// Used to toggle the visibility behavior of the optional decorating app.widgets
...
class FragmentsTextField extends StatefulWidget {
  ...
  const FragmentsTextField({
    ...
    this.placeholderStyle =
        const TextStyle(fontWeight: FontWeight.w300, color: _kInactiveTextColor),
    this.prefix,
  ...
  /// {@macro flutter.app.widgets.editableText.keyboardType}
  ...
  /// {@macro flutter.app.widgets.editableText.textCapitalization}
  ...
  /// {@macro flutter.app.widgets.editableText.strutStyle}
  final StrutStyle strutStyle;

  /// {@macro flutter.app.widgets.editableText.textAlign}
  final TextAlign textAlign;

  /// {@macro flutter.app.widgets.editableText.readOnly}
  final bool readOnly;

  /// {@macro flutter.app.widgets.editableText.showCursor}
  final bool showCursor;

  /// {@macro flutter.app.widgets.editableText.autofocus}
  final bool autofocus;

  /// {@macro flutter.app.widgets.editableText.obscureText}
  final bool obscureText;

  /// {@macro flutter.app.widgets.editableText.autocorrect}
  final bool autocorrect;

  /// {@macro flutter.app.widgets.editableText.maxLines}
  final int maxLines;

  /// {@macro flutter.app.widgets.editableText.minLines}
  final int minLines;

  /// {@macro flutter.app.widgets.editableText.expands}
  final bool expands;
  ...
  /// {@macro flutter.app.widgets.editableText.onChanged}
  final ValueChanged<String> onChanged;

  /// {@macro flutter.app.widgets.editableText.onEditingComplete}
  final VoidCallback onEditingComplete;

  /// {@macro flutter.app.widgets.editableText.onSubmitted}
  final ValueChanged<String> onSubmitted;

  /// {@macro flutter.app.widgets.editableText.inputFormatters}
  ...
  /// {@macro flutter.app.widgets.editableText.cursorWidth}
  final double cursorWidth;

  /// {@macro flutter.app.widgets.editableText.cursorRadius}
  ...
  /// {@macro flutter.app.widgets.editableText.scrollPadding}
  final EdgeInsets scrollPadding;

  /// {@macro flutter.app.widgets.editableText.enableInteractiveSelection}
  final bool enableInteractiveSelection;

  /// {@macro flutter.app.widgets.scrollable.dragStartBehavior}
  final DragStartBehavior dragStartBehavior;

  /// {@macro flutter.app.widgets.editableText.scrollController}
  final ScrollController scrollController;

  /// {@macro flutter.app.widgets.edtiableText.scrollPhysics}
  ...
  @override
  _FragmentsTextFieldState createState() => _FragmentsTextFieldState();
...
class _FragmentsTextFieldState extends State<FragmentsTextField>
  ...
  @override
  void didUpdateWidget(FragmentsTextField oldWidget) {
  ...
  void _handleForcePressEnded(ForcePressDetails details) {
    ...
    if (_shouldShowSelectionToolbar) _editableText.showToolbar();
  }
  ...
  Widget _addTextDependentAttachments(
    ...
    // If there are no surrounding app.widgets, just return the core editable text
    // part.
  ...
  Widget build(BuildContext context) {
    ...
    final Offset cursorOffset =
        Offset(_iOSHorizontalCursorOffsetPixels / MediaQuery.of(context).devicePixelRatio, 0);
